             ...
             <?php
              ...
              <li>
                <a href="<?php echo get_permalink(); ?>">
                  <div class="eventlist__image" style="background-image:url(<?php the_field('archive_page_image') ?>)"><img src="https://250jtjcw4ft1z4tcc2rpahl1-wpengine.netdna-ssl.com/en-us/wp-content/themes/fujifilm-x_jp/assets/img/common/cover.png"></div>
